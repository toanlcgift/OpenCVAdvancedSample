...
namespace SamplesCore
{
    ...
    class HoughLinesSample : ISample
    {
        ...
        {
            // (1) Load the image
            using (Mat imgGray = new Mat("C:\\Users\\toan.nd\\Desktop\\Capture.PNG", ImreadModes.Grayscale))
            using (Mat imgStd = new Mat("C:\\Users\\toan.nd\\Desktop\\Capture.PNG", ImreadModes.Color))
            using (Mat imgProb = imgStd.Clone())
            {
                // Preprocess
                Cv2.Canny(imgGray, imgGray, 100, 200, 3, false);
                ...
                for (int i = 0; i < limit; i++ )
                {
                    ...
                    imgStd.Line(pt1, pt2, Scalar.Red, 1, LineTypes.Link8, 0);
                }
